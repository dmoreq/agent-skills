...
echo "       ./setup.sh"
echo ""
echo "[Option 2: Skills Only (Google Antigravity Global Config)]"
echo "  1. Copy 'skills.tar.gz' to target machine"
echo "  2. Extract directly to Antigravity global skills directory:"
echo "       mkdir -p ~/.gemini/config/skills"
